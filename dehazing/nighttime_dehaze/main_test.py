...
def parse_args():
    ...
    parser.add_argument('--datasetpath', type=str, default='dataset', help='dataset_path')
    ...
    parser.add_argument('--result_dir', type=str, default='results2', help='Directory name to save the results')
